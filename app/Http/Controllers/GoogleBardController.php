...
// Import GuzzleHttp for making HTTP requests
...
class GoogleBardController extends Controller
{
    ...
    public function processNLP(Request $request)
    {
        ...
        curl_setopt_array(
            $curl,
            [
                CURLOPT_URL => 'https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=' . env('GEMINI_API_KEY'), // your preferred link
